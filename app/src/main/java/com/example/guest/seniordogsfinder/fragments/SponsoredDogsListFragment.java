 ...
 */
public class SponsoredDogsListFragment extends Fragment implements OnStartDragListener{
    ...
    public SponsoredDogsListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sponsored_dogs_list, container, false);
    ...
    private void setUpFirebaseAdapter() {
        ...
        mFirebaseAdapter = new FirebaseDogListAdapter(Dog.class,
                R.layout.dog_list_item_drag, FirebaseSponsoredDogViewHolder.class,
